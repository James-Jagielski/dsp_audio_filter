...
module test_ideal_pipelined_multiplier;
   ...
   initial begin
      $dumpfile("ideal_pipelined_multiplier.fst");
   ...
   logic signed [2*N-1:0] product;              // From DUT of ideal_pipelined_multiplier.v
   ...
   logic                valid;                  // From DUT of ideal_pipelined_multiplier.v
   // End of automatics
   ideal_pipelined_multiplier #(.N(N))
   DUT (.frame (frame),
        /*AUTOINST*/
        // Outputs
